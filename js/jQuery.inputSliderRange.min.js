...
while(i<=100){
	...
	if(i==size){
		var rangecontent="#range_content" + j;
    var labelchild=".range_slider_label ul li:nth-child("+j+")";
		$(".between_you_us_tab").css("display","none");
		$(rangecontent).css("display","block");
    $(".range_slider_label ul li").removeClass("active");
    $(labelchild).addClass("active");
	}
